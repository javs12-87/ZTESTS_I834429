CLASS zcl_email_test DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS: get_attachment IMPORTING lv_template TYPE string RETURNING VALUE(ls_encoded) TYPE cmis_s_content_raw.
...
CLASS ZCL_EMAIL_TEST IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        ...
        lo_mail->add_recipient( 'jorge.baltazar@sap.com' ).
        " lo_mail->add_recipient( iv_address = 'recipient2@yourcompany.com' iv_copy = cl_bcs_mail_message=>cc ).
        lo_mail->set_subject( 'Test Mail' ) ##NO_TEXT.
        lo_mail->set_main( cl_bcs_mail_textpart=>create_instance(
          iv_content      = '<html xmlns:v="urn:schemas-microsoft-com:vml"' && |\n|  &&
                            ...
                            '  <o:Created>2023-04-19T01:29:00Z</o:Created>' && |\n|  &&
                            '  <o:LastSaved>2023-04-19T01:29:00Z</o:LastSaved>' && |\n|  &&
                            '  <o:Pages>1</o:Pages>' && |\n|  &&
                            '  <o:Words>337</o:Words>' && |\n|  &&
                            '  <o:Characters>1924</o:Characters>' && |\n|  &&
                            '  <o:Lines>16</o:Lines>' && |\n|  &&
                            ...
                            '         <v:imagedata src="Start%20Registration.fld/image001.png" o:title="SAP Logo"/>' && |\n|  &&
                            '         <w:wrap type="square" anchory="line"/>' && |\n|  &&
                            '        </v:shape><![endif]--><![if !vml]><img width=136 height=51' && |\n|  &&
                            '        src="Start%20Registration.fld/image001.png" align=right alt="SAP Logo"' && |\n|  &&
                            ...
                            '        class=subheader1><span style=''color:white''>Registrat</span></span></span><span' && |\n|  &&
                            '        style=''mso-bookmark:Top_e''><span class=subheader1><span lang=ES' && |\n|  &&
                            '        style=''color:white;mso-ansi-language:ES''>ion Process</span></span></span><span' && |\n|  &&
                            '        style=''mso-bookmark:Top_e''><span lang=ES style=''mso-ansi-language:ES''><o:p></o:p></span></span></p>' && |\n|  &&
                            '        </td>' && |\n|  &&
                            ...
                            '         <v:imagedata src="Start%20Registration.fld/image002.png" o:title=""/>' && |\n|  &&
                            '        </v:shape><![endif]--><![if !vml]><img width=124 height=124' && |\n|  &&
                            '        src="Start%20Registration.fld/image002.png" v:shapes="Picture_x0020_2"><![endif]></span><span' && |\n|  &&
                            ...
                            '        you for showing your interest in the 5Steps2Fiori bootcamp. </span><span' && |\n|  &&
                            '        lang=EN-US style=''font-family:"Arial",sans-serif;mso-ansi-language:' && |\n|  &&
                            '        EN-US''>To continue with your registration process we request you to' && |\n|  &&
                            '        follow the next steps:<o:p></o:p></span></p>' && |\n|  &&
                            ...
                            '        "Arial",sans-serif''>Please complete the attached registration form and' && |\n|  &&
                            '        send it back to us confirming your participation. Please include the' && |\n|  &&
                            '        name of all the team members who will join the bootcamp.</span><span' && |\n|  &&
                            '        lang=EN-IN style=''font-family:"Arial",sans-serif;mso-fareast-font-family:' && |\n|  &&
                            '        "Times New Roman"''><o:p></o:p></span></p>' && |\n|  &&
                            '        <p class=MsoNormal><span style=''font-family:"Arial",sans-serif;' && |\n|  &&
                            '        mso-fareast-font-family:"Times New Roman"''><o:p>&nbsp;</o:p></span></p>' && |\n|  &&
                            '        <p class=MsoNormal><b><span lang=EN-US style=''font-family:"Arial",sans-serif;' && |\n|  &&
                            '        mso-fareast-font-family:"Times New Roman";mso-ansi-language:EN-US''>Participants:</span></b><span' && |\n|  &&
                            '        lang=EN-US style=''font-family:"Arial",sans-serif;mso-fareast-font-family:' && |\n|  &&
                            '        "Times New Roman";mso-ansi-language:EN-US''> T</span><span' && |\n|  &&
                            '        style=''font-family:"Arial",sans-serif;mso-fareast-font-family:"Times New Roman"''>he' && |\n|  &&
                            '        bootcamp requires different roles to complete the exercises (Technical' && |\n|  &&
                            '        / Basis Expert, Application Expert, ABAP Developer</span><span' && |\n|  &&
                            '        lang=EN-US style=''font-family:"Arial",sans-serif;mso-fareast-font-family:' && |\n|  &&
                            '        "Times New Roman";mso-ansi-language:EN-US''>, </span><span' && |\n|  &&
                            '        style=''font-family:"Arial",sans-serif;mso-fareast-font-family:"Times New Roman"''>Security' && |\n|  &&
                            '        Authorizations Expert</span><span lang=EN-US style=''font-family:"Arial",sans-serif;' && |\n|  &&
                            '        mso-fareast-font-family:"Times New Roman";mso-ansi-language:EN-US''> and' && |\n|  &&
                            '        Analytics</span><span style=''font-family:"Arial",sans-serif;mso-fareast-font-family:' && |\n|  &&
                            ...
                            '        lang=EN-US>be sure to include all required roles in the Team members' && |\n|  &&
                            '        section of the registration form.<o:p></o:p></span></span></p>' && |\n|  &&
                            '        <p class=MsoNormal><b><span style=''font-family:"Arial",sans-serif''><o:p>&nbsp;</o:p></span></b></p>' && |\n|  &&
                            '        <p class=MsoNormal><b><span style=''font-family:"Arial",sans-serif''>Environment' && |\n|  &&
                            '        for bootcamp:</span></b><b><span style=''font-family:"Arial",sans-serif;' && |\n|  &&
                            '        mso-ansi-language:EN-US''> </span></b><span lang=EN-US style=''font-family:' && |\n|  &&
                            '        "Arial",sans-serif;mso-ansi-language:EN-US''>You need to provide your' && |\n|  &&
                            '        own system which is where you will run the exercises on - </span><span' && |\n|  &&
                            '        style=''font-family:"Arial",sans-serif''>SAP S/4HANA 202</span><span' && |\n|  &&
                            '        lang=EN-US style=''font-family:"Arial",sans-serif;mso-ansi-language:' && |\n|  &&
                            '        EN-US''>2</span><span style=''font-family:"Arial",sans-serif''> or 202</span><span' && |\n|  &&
                            '        lang=EN-US style=''font-family:"Arial",sans-serif;mso-ansi-language:' && |\n|  &&
                            '        EN-US''>1</span><span style=''font-family:"Arial",sans-serif''> system' && |\n|  &&
                            '        with embedded Fiori frontend server (Bring Your Own sandbox or SAP' && |\n|  &&
                            '        Cloud Appliance Library Instance)</span><span lang=EN-US' && |\n|  &&
                            '        style=''font-family:"Arial",sans-serif;mso-ansi-language:EN-US''>.<o:p></o:p></span></p>' && |\n|  &&
                            '        <p class=MsoNormal><span lang=EN-US style=''font-family:"Arial",sans-serif;' && |\n|  &&
                            '        mso-ansi-language:EN-US''><o:p>&nbsp;</o:p></span></p>' && |\n|  &&
                            '        <p class=MsoNormal><b><span lang=EN-US style=''font-family:"Arial",sans-serif;' && |\n|  &&
                            '        mso-ansi-language:EN-US''>Guests:</span></b><span lang=EN-US' && |\n|  &&
                            '        style=''font-family:"Arial",sans-serif;mso-ansi-language:EN-US''> In the additional' && |\n|  &&
                            '        members section of the registration form you can add as many people as' && |\n|  &&
                            '        you wish in the embedded excel. The people registered in this embedded' && |\n|  &&
                            '        excel file would be considered listeners and will be able to join the' && |\n|  &&
                            '        live sessions but have no responsibility on running the hands-on exercises,' && |\n|  &&
                            '        only people listed as team members (basis, functional, developer,' && |\n|  &&
                            '        security, analytics) would be responsible of running the provided' && |\n|  &&
                            '        exercises.<o:p></o:p></span></p>' && |\n|  &&
                            '        <p class=MsoNormal><span style=''font-family:"Arial",sans-serif''><o:p>&nbsp;</o:p></span></p>' && |\n|  &&
                            '        <p class=MsoNormal><b><span style=''font-family:"Arial",sans-serif''>IMPORTANT</span></b><span' && |\n|  &&
                            '        style=''font-family:"Arial",sans-serif''>: There are limited spaces' && |\n|  &&
                            '        available for the bootcamp. Confirmation of registration will be on the' && |\n|  &&
                            '        first-come-first-served basis</span><span lang=EN-US style=''font-family:' && |\n|  &&
                            ...
                            '       <v:imagedata src="Start%20Registration.fld/image003.jpg" o:title="Divider"/>' && |\n|  &&
                            '      </v:shape><![endif]--><![if !vml]><img width=435 height=2' && |\n|  &&
                            '      src="Start%20Registration.fld/image003.jpg" alt=Divider v:shapes="Picture_x0020_1"><![endif]></span><span' && |\n|  &&
                            '      style=''mso-fareast-font-family:"Times New Roman";mso-bidi-font-family:' && |\n|  &&
                            '      Calibri;color:#222222''><o:p></o:p></span></p>' && |\n|  &&
                            '      </td>' && |\n|  &&
                            '     </tr>' && |\n|  &&
        ...
        ls_content = get_attachment( lv_template =  '1').
        ls_string = ls_content-stream.
      ...
      CATCH cx_bcs_mail_config INTO DATA(write_error).
        "handle exception
        out->write( write_error->get_longtext( ) ).
      CATCH cx_bcs_mail INTO DATA(lx_mail).
        " handle exceptions here
        out->write( lx_mail->get_longtext( ) ).
    ENDTRY.
